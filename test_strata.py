...
import helpers as strata_helpers
...
def temp_storage(tmp_path, monkeypatch):
    ...
    storage folder. Patches both main.TIER_DIRS and config.TIER_DIRS so
    helpers.py (which reads config.TIER_DIRS directly) also uses the
    temporary paths."""
    tier_dirs = {}
